...
The instances are encoded as unconstrained binary optimization problem on a complement of a graph. Thus, the densest k-subgraph problem become an equivalent sparsest k-subgraph problem on a graph complement. The objective is modified as follows: 
