...
class QuboTriU(PrintInfo):
    ...
    def __init__(self, g: Graph):
        ...
        self.summary_info = {'Q': [], 'lambda': [], 'mu_half': [], 'norm_Q': []}
    ...
    def update(self, l: float, mu: float=0, k: int=0) -> QUBOMatrix:
        ...
        self.summary_info['Q'].append(Q)
        self.summary_info['lambda'].append(l)
        self.summary_info['mu_half'].append(mu)
        self.summary_info['norm_Q'].append(float(np.linalg.norm(Q)))
...
class QuadraticPenalty(Algorithm):
    def __init__(self, g: Graph, k: int, initial_mu: float, step: float, mu_maximum_number_of_iterations: int, method: Sampler):
        ...
        self.step = step
        self.k = k
        self.mu_maximum_number_of_iterations = mu_maximum_number_of_iterations
        self.mu_number_of_iterations = 0
    ...
    def update_lambda_mu(self, k: int) -> bool:
        ...
        if self.mu_number_of_iterations < self.mu_maximum_number_of_iterations:
            self.mui += self.step
            self.mu_number_of_iterations += 1
    ...
    def summary(self) -> dict:
        ...
        summary['mui'] = self.mui
        summary['mu_number_of_iterations'] = self.mu_number_of_iterations
        summary['mu_maximum_number_of_iterations'] = self.mu_maximum_number_of_iterations
        return summary
    ...
    def __str__(self):
        ...
        return ( 
            ...
            f'(g={self.g.number_of_nodes(), self.g.number_of_edges()},'
            f'k={self.k}, method={self.method}, result={self.result.__name__},'
            f'initial_mu={self.initial_mu}, step={self.step}, mu_max_iterations={self.mu_maximum_number_of_iterations}))\n'
            f'lambdai={self.lambdai}, mui={self.mui} \n'
...
class MaxIndependentSet(Algorithm):
    ...
    def summary(self) -> dict:
        ...
        summary['best_lambda'] = self.best_lambda
    ...
    def __str__(self) -> str:
        ...
        return ( 
            ...
            f'best_lambda={self.best_lambda}'
        )
